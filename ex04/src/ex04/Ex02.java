...
어차피 알람 소리를 들으면, 알람을 끄고 조금 더 잘 것이기 때문이다. 이 방법을 사용하면, 매일 아침 더 잤다는 기분을 느낄 수 있고, 
학교도 지각하지 않게 된다.
...
*/
		...
		int aa = scan.nextInt(); //시작하는 시
		int bb = scan.nextInt(); //시작하는 분
		int cc = scan.nextInt(); //필요한 시간
		
		int min = 60 * aa+bb; //2640
